...
<head>
    ...
    <title>Tambah Data Gunung - Pendaki.id</title>
            ...
            <div class="flex flex-col gap-6">
                ...
                <div class="bg-white p-6 rounded-3xl shadow-sm border border-slate-200">
                    <div class="flex items-center justify-between">
                        <div>
                            <h1 class="text-2xl font-black text-slate-900">Tambah Data Gunung</h1>
                            <p class="text-sm text-slate-500 mt-1">Silakan isi formulir untuk menambahkan data gunung baru.</p>
                        </div>
                ...
                <div class="bg-white rounded-3xl shadow-sm border border-slate-200 p-8">
                    <form action="<?= base_url('admin/gunung/store') ?>" method="post" class="flex flex-col gap-6">
                        <?= csrf_field() ?>
                        
                        <div class="flex flex-col gap-2">
                            <label for="nama_gunung" class="text-sm font-bold text-slate-700">Nama Gunung</label>
                            <input type="text" id="nama_gunung" name="nama_gunung" placeholder="Contoh: Gunung Semeru" required
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <input type="text" id="lokasi" name="lokasi" placeholder="Contoh: Malang, Jawa Timur" required
                                class="w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-700 focus:border-emerald-500 focus:bg-white focus:outline-none transition">
                        </div>

                        <div class="flex flex-col gap-2">
                            <label for="kapasitas_max" class="text-sm font-bold text-slate-700">Kapasitas Maksimal Kuota (Orang/Hari)</label>
                            <input type="number" id="kapasitas_max" name="kapasitas_max" placeholder="Contoh: 200" required
                                class="w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-700 focus:border-emerald-500 focus:bg-white focus:outline-none transition">
                        </div>
