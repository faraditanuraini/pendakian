...
<head>
    ...
    <title>Tambah Partner - Admin Pendaki.id</title>
...
<body class="bg-[#f4f7f6] text-slate-900 min-h-screen font-sans">
    ...
    <div class="ml-64 min-h-screen">
        <header class="bg-white/90 backdrop-blur sticky top-0 z-10 border-b border-slate-200 px-8 py-6 flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-black text-slate-900">Tambah Partner</h1>
                <p class="text-sm text-slate-500 mt-1">Tambahkan partner lokal baru ke sistem.</p>
            </div>
        ...
        <main class="p-8">
            <div class="max-w-3xl rounded-3xl bg-white border border-slate-200 shadow-sm p-8">
                <form action="<?= base_url('admin/partners/store') ?>" method="post" class="space-y-6">
                    <div>
                    ...
                    <div class="flex justify-end gap-3">
                        ...
                        <button type="submit" class="rounded-3xl bg-emerald-600 px-6 py-3 text-sm font-bold text-white hover:bg-emerald-700 transition">Simpan Partner</button>
                    </div>
                </form>
            </div>
        </main>
